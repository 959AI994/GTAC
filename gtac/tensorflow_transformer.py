...
class Seq2SeqTransformer(keras.Model):
  ...
  def __init__(self,
    ...
    self.value_head = keras.layers.Dense(1, activation=None, name='value_head')
  ...
  def call(self, inputs, training=None, mask=None, return_kv_cache=False, return_last_token=False, return_value=False):
    ...
    Modified: by gst 2025/9/21
      return_value: whether return values for ppo finetuning.
    """
