...
Abc_Obj_t * Abc_NtkDupObj( Abc_Ntk_t * pNtkNew, Abc_Obj_t * pObj, int fCopyName )
{
    ...
    // by wenhui
    pObjNew->oriId = pObj->oriId;
    pObjNew->fMarkA = pObj->fMarkA;
    pObjNew->fMarkB = pObj->fMarkB;
    pObjNew->fMarkC = pObj->fMarkC;
    pObjNew->fMarkE = pObj->fMarkE;
    pObjNew->markValue = pObj->markValue;
    pObjNew->order = pObj->order;
    pObjNew->constType = pObj->constType;
