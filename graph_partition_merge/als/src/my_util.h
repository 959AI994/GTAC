...
static bool DoubleEqualPro(double a, double b, int n_digits = 6) {
    if (a == b) return true;

    std::ostringstream ss1, ss2;
    ss1 << std::setprecision(n_digits) << std::scientific << a;
    ss2 << std::setprecision(n_digits) << std::scientific << b;
